  ...
  module ESProfile
    ...
    def self.included(receiver)
      receiver.class_eval do
        index_name ES::ESCommon.indexify('profiles')
        settings(
    ...
    def as_indexed_json(options = {})
      return {} unless my_candidate && talent && profilable_type != 'Talent'
      ...
      json = {
        ...
        industry_name: talent.talent_preference ? talent.talent_preference.industries.pluck(:name) : [],
        years_of_experience: (
        ...
        contact_by_phone: talent.contact_by_phone,
        contact_by_email: talent.contact_by_email,
        relocate: talent.willing_to_relocate,
        work_authorization: talent.work_authorization,
        sin: talent.sin,
        headline: headline,
        languages: languages.pluck(:name).compact,
        timezone: talent.timezone.as_json(except: [:id]),
        matching_job_title: talent.matching_job_title,
        created_at: created_at,
        agency_id: agency_id,
        talent_id: talent_id,
        hiring_organization_id: hiring_organization_id,
        coordinates: { lat: latitude, lon: longitude },
        user_id: profilable_id
      }
